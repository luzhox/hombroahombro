...
<div class="formulario-donante">
    ...
    <form action="" >
    <div id="cerrardonante" class="icon-close"></div>
    ...
    <div class="input-field nombres">
          ...
          <div class="input-field correo">
            <input type="number"  onfocus="abrirform(this)" onblur="cerrarform(this)" required="">
            <label for="">Celular</label>
            <span class="show-error"><b>!</b>Su celular debe contener 9 digitos</span>
          </div>

          <div class="input-field correo">
            <input type="email"  onfocus="abrirform(this)" onblur="cerrarform(this)" required="">
